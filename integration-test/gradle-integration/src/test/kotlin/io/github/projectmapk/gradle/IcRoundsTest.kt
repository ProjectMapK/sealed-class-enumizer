...
class IcRoundsTest {
    private val siFile = "src/main/kotlin/io/github/projectmapk/icrounds/Si.kt"
    private val leafAFile = "src/main/kotlin/io/github/projectmapk/icrounds/LeafA.kt"
    private val leafBFile = "src/main/kotlin/io/github/projectmapk/icrounds/LeafB.kt"
    private val leafCFile = "src/main/kotlin/io/github/projectmapk/icrounds/LeafC.kt"
    private val leafDFile = "src/main/kotlin/io/github/projectmapk/icrounds/LeafD.kt"
    private val mid2File = "src/main/kotlin/io/github/projectmapk/icrounds/Mid2.kt"
    private val useFile = "src/main/kotlin/io/github/projectmapk/icrounds/Use.kt"
    private val mainFile = "src/main/kotlin/io/github/projectmapk/icrounds/Main.kt"
    private val generatedPrefix = "io/github/projectmapk/icrounds/SI\$"
    ...
    private val accessorHiddenFile = "src/main/kotlin/io/github/projectmapk/ickacc/KaHidden.kt"
    private val accessorGeneratedPrefix = "io/github/projectmapk/ickacc/KaSi\$Enumish"
    private val accessorOut = listOf("ENTRIES=Leaf,KaPriv,Visible", "VALUEOF=Leaf,KaPriv")

    private val scopeFixture = "ic-scope-tracking"
    private val scAliasFile = "src/main/kotlin/io/github/projectmapk/icscope/ScAlias.kt"
    private val scAliasMovedFile = "src/main/kotlin/io/github/projectmapk/icscope/ScAliasMoved.kt"
    private val scNameFile = "src/main/kotlin/io/github/projectmapk/icscope/ScName.kt"
    ...
    fun baseAbsentRoundReportsMonotonicDiagnostics() {
        ...
        TestKitHarness.writeFile(
            dir,
            "src/main/kotlin/io/github/projectmapk/icrounds/Dup1.kt",
            "package io.github.projectmapk.icrounds\n\nobject H1 {\n    data object Dup : SI\n}\n",
        )
        TestKitHarness.writeFile(
            dir,
            "src/main/kotlin/io/github/projectmapk/icrounds/Dup2.kt",
            "package io.github.projectmapk.icrounds\n\nobject H2 {\n    data object Dup : SI\n}\n",
        )
    ...
    fun accessorEntriesSurviveEditsAndNewLeafRound() {
        ...
        TestKitHarness.writeFile(
            dir,
            "src/main/kotlin/io/github/projectmapk/ickacc/KaNew.kt",
    ...
    fun scopeResolutionEditsInOtherFilesMatchCleanBuild() {
        ...
        assertTrue(
            "io/github/projectmapk/icscope/ScAliasLeaf\$Companion.class" !in detached.keys,
    ...
    private fun isAliasFileAttribution(key: String): Boolean =
        key == "io/github/projectmapk/icscope/ScAliasKt.class" ||
            key == "io/github/projectmapk/icscope/ScAliasMovedKt.class" ||
