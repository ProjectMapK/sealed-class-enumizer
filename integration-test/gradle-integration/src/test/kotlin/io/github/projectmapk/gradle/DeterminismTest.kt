...
class DeterminismTest {
    ...
    private val sFile = "src/main/kotlin/io/github/projectmapk/det/S.kt"
    private val midFile = "src/main/kotlin/io/github/projectmapk/det/Mid.kt"
    ...
    private val generatedPrefix = "io/github/projectmapk/det/S\$Enumish"
    ...
    fun sharedFileHierarchiesRegenerateTogetherKeepBytes() {
        ...
        val twoFile = "src/main/kotlin/io/github/projectmapk/shared/Two.kt"
        val sbPrefix = "io/github/projectmapk/shared/SB\$Enumish"
        assertEquals(
            listOf("SA=A1", "SB=B1"),
    ...
    fun toStringFollowsSupertypeEditAcrossFiles() {
        ...
        val withToStringFile = "src/main/kotlin/io/github/projectmapk/det/WithToString.kt"
        assertEquals(expectedOut, IcTestSupport.outLines(TestKitHarness.build(dir, "runMain")))
