...
class ProbeGateTest : DiagTestBase() {
    ...
    fun annotationNotationBehaviorIsPinned() {
        ...
        TestKitHarness.deleteFile(dir, "src/main/kotlin/org/wrongwrong/probe/alias/AaImport.kt")
        ...
        TestKitHarness.deleteFile(dir, "src/main/kotlin/org/wrongwrong/probe/alias/AaTypealias.kt")
