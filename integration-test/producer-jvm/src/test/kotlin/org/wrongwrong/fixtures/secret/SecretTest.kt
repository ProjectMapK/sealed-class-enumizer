...
class SecretTest {
    // TC-LEAF-088 / TC-BOX-073: 基底内ネストの private 末端は KIND_NOT_ACCESSIBLE にならず
    // （このフィクスチャがコンパイルできること自体が非発火の証明）、entries に載り valueOf で解決できる
    @Test
    ...
    // 可視範囲の外（このテストファイル）からも label は entries 経由で観測される（エッジ §1.2 の帰結）
    @Test
