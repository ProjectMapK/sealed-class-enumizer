...
class EnumizeNamesTest {
    ...
    private fun namesFromDeclarations(): Map<String, String> = mapOf(
        ...
        "EnumishEntriesHolder.enumizedRootClass" to EnumizeEntriesHolderProbe::enumizedRootClass.name,
        ...
        "EnumishEntriesHolder.getByLabelOrNull" to EnumishEntriesHolder<*>::getByLabelOrNull.name,
    )

    private fun namesFromConstants(): Map<String, String> = mapOf(
