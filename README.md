...
plugins {
    ...
    id("io.github.projectmapk.sealed-class-enumizer") version "2.4.10-0.1.2"
}
```
...
| Version format | `<KotlinVersion>-<pluginVersion>`, e.g. `2.4.10-0.1.2` |
